...
def developer_revealed(repository, repo, contributor):
    #repository = github object, repo = my class object, contributor = nameduser
    scream.say('assigning a contributor: ' + contributor + ' to a repo: ' + repository)
        ...
        if resume_stage in [None, 'contributors']:
            try:
                ...
                for contributor in contributors:
                    ...
                    check_quota_limit()
                    developer_revealed(repository, repo, contributor)
